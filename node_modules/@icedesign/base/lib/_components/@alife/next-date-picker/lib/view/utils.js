...
var utils = {
    ...
    getFormat: function getFormat(formater, format) {
        ...
        var dateTimeFormat = isFunction(dateFormat) ? dateFormat : [dateFormat, timeFormat].join(' ').trim();
        return {
    ...
    parseDateParts: function parseDateParts(momentObject, dateFormat, timeFormat, dateTimeFormat) {
        ...
        var dateTimeString = dateTimeFormat ? formatDate(dateValue, dateTimeFormat) : [dateString, timeString].join(' ').trim();
